...
const QuizModal = ({
  ...
  const generateQuesError = (amount, difficulty) => {
    ...
    if (amount < 3 || amount > 20) {
      Alert.alert(
        "Fill the fields",
        "Please Enter a number of questions you want between 3 and 20"
      );
      return false;
    }
    if (!difficulty) {
  ...
  const handleQuizSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      try {
        ...
        const { data } = await axios.post("/post/create-quiz", {
          title,
          description,
          quizQuest: questions,
          likes: 0,
          rating: 0,
          postType: selectedOptionQuiz,
        });
  ...
  return (
    <View>
      {selectedOptionQuiz === "videowithquiz" && (
        <Modal
          animationType="fade"
          transparent={true}
              ...
              <View className="flex-row space-x-4">
                ...
                >
                  <Image
                    ...
                    style={styles.logo}
                  />
                  <Text className="text-md font-medium tracking-widest absolute bottom-[3px]">
                    Ai
                  </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    setCategories(!categories), setUrlField(false);
                  }}
                >
                ...
                <TouchableOpacity
                  className="h-[45px] w-[45px] items-center justify-center border-[1px] border-slate-400 rounded-md"
                  onPress={() => {
                    setCategories(false), setUrlField(!urlField);
                  }}
                >
          ...
          <View className="w-full rounded-md px-1 space-y-7 mb-4">
            <View className="flex-row space-x-4 mb-4">
              ...
              <TouchableOpacity
                className="h-[45px] w-[45px] items-center justify-center border-[1px] border-slate-400 rounded-md"
                onPress={() => {
                  setCategoriesQuiz(false), setUrlFieldQuiz(!urlFieldQuiz);
                }}
              >
                <Feather name="link" size={22} />
              </TouchableOpacity>
                ...
                >
                  ...
                  >
                    <View className="flex-row items-center">
                      <Text className="font-medium text-lg tracking-widest">
                        Title
                      </Text>
                      {errors.title && (
                        <Text className="text-xs text-red-500 ml-2">
                    ...
                    <MaterialIcons
                      name={
                        isHeader ? "keyboard-arrow-up" : "keyboard-arrow-down"
                      }
                      color="black"
                      size={22}
                    />
            ...
            <TouchableOpacity
              ...
              onPress={
                questions.length ? handleQuizSubmit : generateQuestionsForQuiz
              }
            >
